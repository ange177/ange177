...
|---|---|---|
| [SQL Analysis for E-Commerce Revenue & Customer Intelligence](https://github.com/ange177/sql-ecommerce-analysis) | SQL business intelligence analysis of a year of e-commerce orders: joins, CTEs, and window functions (RANK, NTILE, LAG) surface a 68.5% month-over-month revenue collapse and a customer-concentration risk (top 25% of customers drive 55% of revenue) | SQL |
| [Analysing Predictors of Patient Length of Stay in an Orthopaedic Hospital](https://github.com/ange177/orthopedic-hospital-los-analysis) | Statistical analysis of 79,000+ orthopaedic hospital admissions: hypothesis testing and regression (R² = 0.577) identify surgical delay and surgery count as the biggest levers on Length of Stay, informing bed-capacity and discharge-planning decisions | Python, Statistics |
| [Retail Sales Profitability & Discount Analysis](https://github.com/ange177/retail-sales-profitability-discount-analysis) | Root-cause analysis isolating 3 unrelated drivers of lost profit across region, category, and product, quantifies roughly $24K/year in recoverable margin | Excel, Python, Pandas |
...
| [ETL Pipeline for Data Quality & Revenue Analysis](https://github.com/ange177/etl-pipeline-data-quality-revenue-analysis) | ETL pipeline for a travel booking business joining 3 messy sources into a validated SQLite warehouse: a flag-not-drop data quality decision protected $42,942 in revenue | Python, SQLite, Pandas |
